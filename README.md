...
#windowHolder[style*="display: block;"] #windowCHolder {
    pointer-events: none;
}
...
.classCard[onclick="selectClass(7)"]::after {
    content: " ";
    background-color: var(--accent);
    height: 64px;
    width: 64px;
...
#bottomLeftHolder::before {
    ...
    left: calc(50% - 420px);
    z-index: -2;
    filter: drop-shadow(8px 4px var(--accent));
